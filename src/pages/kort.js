    ...
    return (
        <Layout>
                ...
                <div className="container">
                    <div className="landing-hero-grid">
                        <div className="landing-hero-text">
                            <h1>Køberrådgivning med værdikort</h1>
                            <h2>Pris kr. <span style={{ textDecoration: 'line-through' }}>5.995</span> 5.495,- inkl. moms</h2>
                            <p>
            ...
            <section className="landing-icons-section">
                <div className="container">
                    <h2 className="landing-icons-heading">Dine fordele som køber</h2>
                  ...
                  <p className="testimonial-reviewer-name">
                        ...
                        >
                            <div className="landing-testimonial-review-box">
                                ...
                                />
                                <p className="landing-testimonial-head">
                                    Louise tog os i hånden og guidede os
                </p>
                                <span className="trustpilot-testimonial-img-container">
                                    <Img
                                        fluid={
                            ...
                            <div className="tabs">
                                <div className="tab">
                                    ...
                                    <label className="tab-label" htmlFor="chck1">
                                        Er prisen på kr 5.095 fast, eller skal jeg betale andre
                                        udgifter udover?
                  </label>
                                    <div className="tab-content">
                                        <p>
                                            Du skal kun betale kr. 5.095 i honorar til BoligPartner,
                                ...
                                <div className="tab">
                                    ...
                                    <div className="tab-content">
                                        <p>
                                            ...
                                            Kvalitetsmæssigt er der ingen forskel på den juridiske
